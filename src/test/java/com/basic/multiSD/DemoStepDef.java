...
public class DemoStepDef {
	...
	public void user_enters_first_name() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@id='basicBootstrapForm']/div[1]/div[1]/input")).sendKeys("Jack");
		Thread.sleep(1000);
	}
	...
	public void user_enters_last_name() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@id='basicBootstrapForm']/div[1]/div[2]/input")).sendKeys("Ryan");
		Thread.sleep(1000);
	}
}
